...
urlpatterns =[
    ...
    path("test-table-1", TestTableViews.as_view(), name="test-table-1"),
    path("test-table-2", TestTable2Views.as_view(), name="test-table-2"),
    path("test-table-1/<int:pk>", TestTable1UpdateView.as_view(), name="test-table-1-update")
]
